...
export function ScopePanel({
  ...
  return (
    <div
      className={`relative rounded-[10px] border border-sline bg-ink overflow-hidden ${className}`}
      style={{ height }}
    >
      {/* subtle grid overlay */}
      {showGrid && (
      ...
      {showLabels && (
        <div className="absolute top-2 left-3 right-3 flex justify-between items-center pointer-events-none">
          <div className="flex gap-4 text-[10px] uppercase tracking-[0.14em] font-mono text-stext-2">
            <div className="flex items-center gap-1.5">
              <span className="inline-block w-4 h-px border-t border-dashed border-stext-2" />
              said
            </div>
            <div className="flex items-center gap-1.5">
