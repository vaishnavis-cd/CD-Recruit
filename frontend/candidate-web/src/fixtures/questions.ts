...
export const MODULES = [
  ...
  { index: 3, name: 'AI Prompting', type: 'prompting' as const, suggestedMinutes: 15, questionIds: PROMPTING_QUESTIONS.map(q => q.id) },
  { index: 4, name: 'Contextual Simulation', type: 'contextual' as const, suggestedMinutes: 20, questionIds: CONTEXTUAL_QUESTIONS.map(q => q.id) },
]
