...
This document serves as the authoritative technical catalog of **all API endpoints** implemented in the CD-Recruit backend (`codebase/backend/api`). It covers all 23 controllers, routes, guards, request bodies, and business logic.
